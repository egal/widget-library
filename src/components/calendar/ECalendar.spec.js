...
function getCurrentDate() {
  ...
  let [currentMonth, _, currentYear] = currentDate.split(' ')
...
describe('Styles + Render', () => {
  ...
  it('should render hours and minutes options for select (12h format)', () => {
    ...
    cy.get('.select.select--hours .dropdown-items .dropdown-item').should('have.length', 12)
  ...
  it('should render hours options for select (24h format)', () => {
    preMount({
    ...
    cy.calendarSelectDate()
    cy.get('.footer .picker .select.select--hours').click()
    cy.get('.select.select--hours .dropdown-items .dropdown-item').should('have.length', 24)
  })
})

describe('Selecting Single Date', () => {
...
describe('Selecting Single Date & Time', () => {
  it('should display selected date + time (12h format) and emit value', () => {
    preMount(fixtures.ECalendarProps)
  ...
  it('should set correct selected time in 24h format', () => {
    preMount({
      ...fixtures.ECalendarProps,
      locale: 'en-US',
      timePicker: {
    ...
    cy.calendarSelectDate()
    cy.get('.footer .picker .select.select--hours').click()
    cy.get('.select.select--hours .dropdown-items .dropdown-item').eq(1).click()
...
describe('Select Date Range & Time', () => {
  ...
  it('time selectors should not exist for date range select', () => {
    preMount({
      ...fixtures.ECalendarProps,
      timePicker: null,
      isRange: true,
  ...
  it('should allow to select date range between 2 months', () => {
    preMount({
      ...fixtures.ECalendarProps,
      isDouble: false,
      isRange: true,
...
describe('Time Select', () => {
  ...
  it('should allow to select time in 12h format', () => {
    preMount({
      ...fixtures.ECalendarProps,
      timePicker: {
        isAMPM: true,
  ...
  it('should allow to select time in 24h format', () => {
    preMount({
      ...fixtures.ECalendarProps,
      timePicker: {
        isAMPM: false,
...
describe('Double calendar', () => {
  ...
  it('should allow only date range if Doubled', () => {
...
describe('Preset Values', () => {
  ...
  it('should render preselected start date', () => {
    preMount({
      ...fixtures.ECalendarProps,
      isRange: false,
      timePicker: null,
  ...
  it('should render preselected start date and 12h time', () => {
    preMount({
      ...fixtures.ECalendarProps,
      isRange: false,
      timePicker: {
  ...
  it('should render preselected start date and 24h time', () => {
    preMount({
      ...fixtures.ECalendarProps,
      isRange: false,
      timePicker: {
  ...
  it('should render preselected past date', () => {
    preMount({
      ...fixtures.ECalendarProps,
      isRange: false,
      timePicker: null,
...
describe('Other conditions', () => {
  it('should display calendar without input', () => {
