...
describe('Styles + Render', () => {
  ...
  it('days that are not in the current month should not be active for Double calendar', () => {
  ...
  it('should not have "doubled" class if there is a Double Calendar (i.e. date range select)', () => {
    preMount({ ...fixtures.ECalendarProps, isDouble: true })
    cy.get('input#calendar-input--date').click()
    cy.get('.date-inputs').should('not.have.class', 'doubled')
  })

  it('should have .single class if no timePicker', () => {
    preMount({ ...fixtures.ECalendarProps, timePicker: null })
    cy.get('.calendar__input').should('have.class', 'single')
  })

  it('should not have .single class if timePicker exists', () => {
    preMount(fixtures.ECalendarProps)
...
describe('Select Single Date & Time + emit', () => {
  it('should display selected date in input + emit', () => {
    preMount({ ...fixtures.ECalendarProps, timePicker: null })
  ...
  it('should display selected date and time in input + emit', () => {
    preMount(fixtures.ECalendarProps)
    ...
    // cy.calendarSelectDateTime().then(() => {
    //   cy.wrap(Cypress.vueWrapper.emitted()).should('have.property', 'update:dateValue')
    // })
    cy.get('#calendar-input--date').should('have.value', currentDate)
...
describe('Conditions', () => {
  ...
  //           iconLeft: 'calendar',
  //           readonly: true,
  //          !!!todo  showFilled: this.mergedData?.timePicker ? !!this.rightInputValue : true,
  //         },
  //         this.data?.inputData,
  ...
  //           readonly: true,
  //          !!!todo showFilled: !!this.leftInputValue,
  //         },
  //         this.data?.inputData,
