...
[//]: # ( todo для каких графиков)
Для некоторых передается набор стилей, для других - опции из библиотеки Chart.js (https://www.chartjs.org/). Используется 3 версия библиотеки. Описание того, что моэно передавать в опциях, можно найти здесь: https://github.com/chartjs/Chart.js/tree/master/docs 


[//]: # ( todo оставить примеры даннхы)