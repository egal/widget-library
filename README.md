...
- поправлены стили стрелочки в ESelect (чтобы окрашивалась в передаваемый цвет)
- изменения в компоненте SelectTime
- Обновлен ReadMe (добавлено описание styleConfig, 4 новых свойства у объекта data (в самом низу таблицы), 3 новых эмита, убран пример json):
