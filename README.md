...
| ``localeOptions``         |      Object      | Объект                                                                                                          | Опции для форматирования даты (те же что и для ``Date.prototype.toLocaleString()``), чтобы кастомизировать отображение даты и времени в инпуте               |
