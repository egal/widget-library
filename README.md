...
- **ESelect**: в объект `:data` добавлен проп `showFilled` (дефолтное значение: true). **Аналогичен такому же пропу для компонента EInput**
...
| ``isExpanded``            |     Boolean      | ``true``, ``false``                                                                                             | Должен ли календарь растягиваться по ширине контейнера. Еслм значение - ``false``, календарь будет иметь дефолтные ширину и высоту                           | 
...
| ``minutesIncrement``      |      Number      | 1 (по умолчанию), 5, 10...                                                                                      | Устанавливает шаг для отображения минут в селекте                                                                                                            |
